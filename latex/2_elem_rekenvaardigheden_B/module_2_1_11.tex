...
\noindent $x$ is een strikt positief reëel getal.
...
\includegraphics[scale=0.5]{\string"figures/log en exp\string".eps}
\end{figure}
...
is dat de logaritmische en exponentiële functies elkaars inverse zijn,
...
\section{Oplossen van logaritmische vergelijkingen}
...
Stap 2: Laat op beide leden van de vergelijking een geschikte exponentiële
functie inwerken.
...
\subsection{Voorbeeld1: ${\displaystyle \log_{a}\left(f(x)\right)=\log_{a}\left(g(x)\right)}$ }
...
\subsection{Voorbeeld2: ${\displaystyle \log_{a}\left(f(x)\right)=c}$ }
...
\subsection{Voorbeeld3: het grondtal is onbekend}
...
\subsection{Voorbeeld4: rekenen met zeer grote en kleine getallen}
...
\section{De logaritmische functie}
...
\end{itemize}
\begin{figure}
\includegraphics[scale=0.5]{\string"figures/de logaritmische functie\string".eps}
\end{figure}
...
\subsection{Voorbeeld: ${\displaystyle y=\log_{2}x}$}
...
\noindent \textbf{Nulpunten}: (stap2) er is altijd één nulpunt; de
...
\begin{figure}
\includegraphics[scale=0.5]{\string"figures/voorbeeld logaritmische functie\string".eps}
\end{figure}
