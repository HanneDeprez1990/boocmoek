...
%\noindent Merk op dat bij een functie voor elke $y$-waarde hoogstens
...
%\subsubsection{Grafische voorstelling}
%
%\noindent Een functie $y=f(x)$ kan altijd grafisch worden weergeven.
%Voor een functie $y=f(x)$ staan de $x$-waarden op de horizontale
%as en de functiewaarden $f(x)$ op de verticale as.
%
%\noindent Het domein lees je af op de horizontale $X$-as (in onderstaande
%voorbeelden aangeduid met een groene lijn) 
%
%\noindent Het beeld lees je af op de verticale $Y$-as (in onderstaande
...
%\noindent Opmerking 1: eigenlijk hebben we dit reeds toegepast om
...
%
%
%\noindent Opmerking 2: een vaak voorkomend probleem is het vinden
