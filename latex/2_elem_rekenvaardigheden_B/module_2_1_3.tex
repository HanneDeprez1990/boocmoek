...
\begin{figure}[h]
	\centering          
	\input{2_elem_rekenvaardigheden_B/Fig_module_2_1_3_verloop_stijgen_dalen}
	\caption{voorbeeld 1}
...
\begin{figure}[h]
	\centering          
	\input{2_elem_rekenvaardigheden_B/Fig_module_2_1_3_verloop_convex_concaaf_buigpunt}
