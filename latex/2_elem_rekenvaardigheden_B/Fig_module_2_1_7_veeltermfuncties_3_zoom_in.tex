\tikzsetfigurename{Fig_module_2_1_7_veeltermfuncties_3_zoom_in}
\begin{center}
...
\draw[->] (-0.4,0) -- (0.1,0) node[right] {$x$};
\draw[->] (0,-0.02) -- (0,0.02) node[above] {$y$};
...
\draw[teal,cap=rect,line width=1, opacity=1, domain=-0.3:0.1] plot (\x, {
