...
\begin{figure}[h]
	...
	\end{subfigure}
	\begin{subfigure}{.48\linewidth}
		\includegraphics[height=5cm]{\string"2_elem_rekenvaardigheden_B/inputs/Verschuiven - verticaal - naar omhoog\string".eps}
	\end{subfigure}
\end{figure}
...
\begin{figure}[h]
	\begin{subfigure}{.5\linewidth}
	\includegraphics[height=5cm]{\string"2_elem_rekenvaardigheden_B/inputs/Herschalen - verticaal - inkrimpen\string".eps}
	\end{subfigure}
	\begin{subfigure}{.5\linewidth}
	\includegraphics[height=5cm]{\string"2_elem_rekenvaardigheden_B/inputs/Herschalen - verticaal - openrekken\string".eps}
	\end{subfigure}	
\end{figure}
