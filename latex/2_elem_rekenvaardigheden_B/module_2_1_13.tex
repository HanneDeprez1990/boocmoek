...
\section{Relatie versus functie}
...
en -1) gedurende één periode twee maal aangenomen. Zo geldt $\sin x=\frac{1}{2}$
...
\noindent We definiëren de cyclometrische functies (ook wel arcfuncties
...
relatie horen bij één waarde uit het domein ($x$-waarde) meerdere
...
niet gedefiniëerd voor hoeken gelijk aan $\frac{\pi}{2}$ en $-\frac{\pi}{2}$,
...
\section{De cyclometrische functies}
...
\subsection{De inverse van de sinusfunctie}
...
\begin{figure}
\includegraphics{figures/Arcsine_Arccosine_svg}
\end{figure}



\subsection{De inverse van de cosinusfunctie}
...
\subsection{De inverse van de tangensfunctie}
...
\begin{figure}
\includegraphics{figures/Arctangent_Arccotangent_svg}
\end{figure}



\subsection{De inverse van de cotangensfunctie}
