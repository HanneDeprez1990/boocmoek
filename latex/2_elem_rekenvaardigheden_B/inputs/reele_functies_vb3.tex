...
%		GRAFIEKEN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw[cyan,cap=rect,thick, domain=-6:5.5] plot (\x, {sin(\x r)}) node[above, right]{${\color{cyan}y=\sin{x}}$};

%\draw[cyan,cap=rect,ultra thick, domain=-6:6] plot(\x,sin(\x));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%verticale lijn
\draw[*-*,line width=2,teal, cap=rect,opacity=0.3] (0,-1.15) -- (0,1.15) node[below,yshift=-2.3cm,right,xshift=+0.3cm,opacity=1] {bld $f  = [-1,1]$};
 
%horizontale lijn

\draw[line width=4,blue, cap=rect,opacity=0.3] (-7,0) -- (7,0) node[above,left,yshift=+0.3cm,opacity=1] {dom$f$ = $\mathbb{R}$};
