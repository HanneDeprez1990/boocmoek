...
\input{2_elem_rekenvaardigheden_B/reele_functies_vb1}
\input{2_elem_rekenvaardigheden_B/reele_functies_vb2}
\input{2_elem_rekenvaardigheden_B/reele_functies_vb3}
\input{2_elem_rekenvaardigheden_B/verloop_vb1}
\input{2_elem_rekenvaardigheden_B/verloop_vb2}

%TODO waarom verschijnt dat hier niet? 

%\input{1_elem_rekenvaardigheden_A/inputs/parRegelSom}
