		\tikzsetfigurename{Fig_module_3_2_7_complex-getal-6-optelling-exp}
...
\begin{center}
	...
	\draw[->,thick,cyan] (0,0) -- (4,3) node[left,xshift=-1.8cm,yshift=-0.5cm] {};
 	...
 	\centerarc[anglecolor](0,0)(0:62:0.7) ; 	 %alpha
 	\centerarc[red](0,0)(0:37:2) ; 	%theta
	\centerarc[blue](0,0)(0:18:1.2) ; 	%beta
	
	\centerarc[orange](3,1)(18:63:1.5) ; 	
	
	
		\centerarc[olive](3,1)(63:200:0.3) ; 	
	
	

	\draw[] (0.4,0.7)	node[right,anglecolor]{$ \alpha$}; 	 
	\draw[] (1.2,0.25)	node[right,blue]{$\beta$}; 	 
	\draw[] (1.8,1)	node[right,red]{$\theta$}; 	 
	...
	\draw[->] (0,0) -- (3,1) node[below,xshift=0cm,yshift=-0.2cm] {$b$};
