...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_2_complex-getal-1.tex} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_2_complex-getal-2.tex} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_3_complex-getal-3-optelling} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_3_complex-getal-4-complex-toegevoegde} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_5_complex-getal-5-goniometrisch.tex} 
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_5_complex-getal-voorbeeld1.tex} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_5_complex-getal-voorbeeld2.tex} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_5_complex-getal-voorbeeld3.tex} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_5_complex-getal-voorbeeld4.tex} 
\end{figure}
...
%\figuurmetlabel[\label{fig:compl_som}]{scale=0.6}{3_gonio_complexe_getallen/inputs/complex-getal-6-optelling-exp.jpg}
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_7_complex-getal-6-optelling-exp} \caption{Grafische voorstelling van de optelling van twee complexe getallen als optelling van vectoren in het complex vlak. De modulus van de som $z=a+b$ wordt berekend met behulp van de cosinusregel.}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_7_product-grafisch} 
\end{figure}
...
\begin{figure}[H]
	\centering 
	\input{3_gonio_complexe_getallen/Fig_module_3_2_8_derdemachtswortels-voorbeeld} 
\end{figure}
